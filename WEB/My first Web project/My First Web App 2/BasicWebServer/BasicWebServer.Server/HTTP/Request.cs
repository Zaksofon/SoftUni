...
namespace BasicWebServer.Server.HTTP
{
    public class Request
    {
        ...
        public static Request Parse(string request)
        {
            ...
            //The startLine is an Array with the "method" and the "url" as a string
        ...
        private static Session GetSession(CookieCollection cookies)
        {
            var sessionId = cookies.Contains(HTTP.Session.SessionCookieName)
                ? cookies[HTTP.Session.SessionCookieName]
        ...
        private static Dictionary<string, string> ParseFormData(string bodyLines)
            => HttpUtility.HtmlDecode(bodyLines)
                .Split('&')
        ...
        private static Method ParseMethod(string method) => method.ToUpper() switch
            {
                "GET" => Method.Get,
                "POST" => Method.Post,
                "PUT" => Method.Put,
